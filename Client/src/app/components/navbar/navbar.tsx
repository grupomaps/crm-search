      ...
      <nav className={`sidebar ${isOpen ? "open" : ""}`}>
        <div className="sidebar-sticky">
          <ul className="nav options flex-column">
            ...
            {cargo !== "marketing" &&
              (cargo === "vendas" || cargo === "adm" || cargo === "supervisor") && (
                <li className="nav-item">
                  <Link
                    className="nav-link icon-tooltip"
                    to="/cancelados"
            ...
            {/* Exibe a opção de "Marketing" se o cargo for 'marketing' */}
            {(cargo === "marketing" ||
              cargo === "financeiro" ||
              cargo === "cobranca" ||
              cargo === "adm" ||
            ...
            {/* Exibe a opção de "Pós Venda" se o cargo for 'posVenda' */}
            ...
            {/* Exibe a opção de "Cobrança" se o cargo for 'cobranca' */}
            {(cargo === "cobranca" || cargo === "adm") && (
              <li className="nav-item">
                <Link
                  className="nav-link icon-tooltip"
                  to="/cobranca"
