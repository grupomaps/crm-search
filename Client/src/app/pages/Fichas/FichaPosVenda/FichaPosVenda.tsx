    ...
    try {
      if (id) {
        ...
        if (data.posVendaConcuida) {
          await adicionarClienteMonitoria(data);
        }
  ...
  const adicionarClienteMonitoria = async (data: any) => {
    try {
      ...
      if (financeirosSnap.exists()) {
        ...
        console.log("Cliente adicionado à coleção mointoria com sucesso!");
      }
    } catch (error) {
      console.error("Erro ao adicionar cliente a monitorias: ", error);
    }
  };
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="card mb-4 p-4">
                ...
                <p>
                  <strong>Valor da Venda:</strong> {formatMoney(clientData.valorVenda)}
                </p>
                <p>
