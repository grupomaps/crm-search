...
export const ListDashboard: React.FC<ListDashboardProps> = ({
  ...
  const [respCancelamento, setRespCancelamento] = useState<string>("");
  ...
  useEffect(() => {
    const fetchVendas = async () => {
      ...
      try {
        ...
        // Exibir todas as vendas para cargos privilegiados
        ...
        <div className="modal-overlay">
          <div className="modal-exclusao">
            ...
            <div className="form-group mb-3">
              <label htmlFor="respCancelamento">
              ...
              <input
                ...
                type="text"
                id="respCancelamento"
                value={respCancelamento}
                onChange={(e) => setRespCancelamento(e.target.value)}
                required
              />
            </div>
            <div className="form-group mb-3">
